...
const isPublicRoute = createRouteMatcher([
    ...
    '/(mn|en|ko|de)',
    '/(mn|en|ko|de)/about(.*)',
    '/(mn|en|ko|de)/packages(.*)',
    '/(mn|en|ko|de)/contact(.*)',
    '/(mn|en|ko|de)/faq(.*)',
    '/(mn|en|ko|de)/tours/(.*)',
    '/(mn|en|ko|de)/mongolia-travel-guide(.*)',
    '/(mn|en|ko|de)/blog(.*)',
    '/(mn|en|ko|de)/destinations(.*)',
    '/(mn|en|ko|de)/custom-trip(.*)',
    '/(mn|en|ko|de)/calendar(.*)',
    '/(mn|en|ko|de)/travel-styles(.*)',
    '/sign-in(.*)',
    '/sign-up(.*)',
    '/sso-callback(.*)',
    '/(mn|en|ko|de)/sign-in(.*)',
    '/(mn|en|ko|de)/sign-up(.*)',
    '/(mn|en|ko|de)/sso-callback(.*)',
    '/sitemap.xml',
    '/robots.txt'
]);
