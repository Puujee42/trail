...
const honeymoonTrips = [
  {
    id: 1,
    title: "Мальдив - Усан Вилла",
    category: "island",
    location: "Мале, Мальдив",
    duration: "6 Өдөр",
    rating: 5.0,
    price: 8500000,
    image: "/maldives.jpg", // Replace with real image
    romanceFactor: "10/10",
    perks: ["Хувийн усан сан", "Лаатай оройн зоог"],
    tag: "Adults Only"
  },
  {
    id: 2,
    title: "Санторини - Нар Жаргах Мөч",
    category: "island",
    location: "Санторини, Грек",
    duration: "7 Өдөр",
    rating: 4.9,
    price: 6200000,
    image: "/santorini.jpg",
    romanceFactor: "9.8/10",
    perks: ["Дарсны амталгаа", "Фото зураг авалт"],
    tag: "Best View"
  },
  {
    id: 3,
    title: "Парис - Хайрын Хот",
    category: "city",
    location: "Парис, Франц",
    duration: "5 Өдөр",
    rating: 4.8,
    price: 4800000,
    image: "/paris-honey.jpg",
    romanceFactor: "9.5/10",
    perks: ["Сена мөрний аялал", "Эйфелийн цамхаг"],
    tag: "Classic"
  },
  {
    id: 4,
    title: "Бора Бора - Диваажин",
    category: "luxury",
    location: "Бора Бора, Францын Полинез",
    duration: "8 Өдөр",
    rating: 5.0,
    price: 12500000,
    image: "/bora.jpg",
    romanceFactor: "10/10",
    perks: ["All Inclusive", "Спа Багц"],
    tag: "VIP Luxury"
  },
  {
    id: 5,
    title: "Венец - Завьтай Аялал",
    category: "city",
    location: "Венец, Итали",
    duration: "5 Өдөр",
    rating: 4.7,
    price: 5100000,
    image: "/venice.jpg",
    romanceFactor: "9.2/10",
    perks: ["Гондола завь", "Дуурь үзэх"],
    tag: "History"
  },
  {
    id: 6,
    title: "Бали - Убуд ширэнгэн ой",
    category: "island",
    location: "Бали, Индонез",
    duration: "10 Өдөр",
    rating: 4.9,
    price: 3900000,
    image: "/bali-honey.jpg",
    romanceFactor: "9.6/10",
    perks: ["Хос массаж", "Цэцгэн банн"],
    tag: "Relax"
  }
];
...
const HoneymoonPage = () => {
  ...
  const filtered = honeymoonTrips.filter(
    ...
    <div className="min-h-screen bg-[#FFF5F7] pt-24 pb-20 overflow-hidden relative">
      ...
      <div className="container mx-auto px-4 relative z-10 max-w-7xl">
        ...
        >
          <AnimatePresence>
            {filtered.map((trip) => (
              <HoneymoonCard key={trip.id} trip={trip} />
            ))}
          </AnimatePresence>
        </motion.div>
...
// 1. Slow Floating Background Elements
...
// 2. Premium Honeymoon Card
const HoneymoonCard = ({ trip }: { trip: any }) => {
  return (
    <motion.div
      layout
    ...
    >
      {/* Golden/Rose Border Gradient on Hover */}
      ...
      <div className="relative h-80 overflow-hidden">
        <Link href={`/packages/honeymoon/${trip.id}`}>
      ...
      <div className="p-8 flex flex-col flex-grow">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
           {trip.perks.map((perk: string, i: number) => (
