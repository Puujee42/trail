...
const packages = [
  {
    ...
    oldPrice: 550000,
    image: "/lake.jpg",
    tags: ["Best Seller", "Хямдрал"],
    featured: true
  },
  {
    id: 2,
    title: "Парис & Европын Тур",
    category: "city",
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        {filteredPackages.length > 0 && (
          <div className="text-center mt-16">
             <button className="px-8 py-3 bg-white border border-slate-200 text-slate-600 font-bold rounded-full hover:bg-slate-50 hover:border-slate-300 transition-all shadow-sm">
                Дараагийн хуудас
             </button>
          </div>
        )}
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="flex justify-between items-start mb-2">
           <div className="flex items-center gap-1 text-yellow-400 text-xs font-bold">
              <FaStar /> {pkg.rating} <span className="text-slate-300 font-medium">({pkg.reviews})</span>
           </div>
