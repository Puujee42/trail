...
const familyTrips = [
  {
    id: 1,
    title: "Токио Диснейленд Аялал",
    category: "theme_park",
    location: "Токио, Япон",
    duration: "5 Өдөр",
    rating: 4.9,
    price: 3800000,
    image: "/tokyo.jpg", // Replace with real image
    ageGroup: "3+ нас",
    perks: ["Дисней тасалбар", "Өглөөний цай"],
    featured: true
  },
  {
    id: 2,
    ...
    category: "resort",
    location: "Анталья, Турк",
    duration: "8 Өдөр",
    rating: 4.8,
    price: 4200000,
    image: "/turkey.jpg",
    ageGroup: "Бүх нас",
    perks: ["Хүүхэд үнэгүй", "Усан парк"],
    featured: false
  },
  {
    id: 3,
    title: "Тэрэлж - Гэр бүлийн амралт",
    category: "nature",
    ...
    image: "/terelj.jpg",
    ageGroup: "Бүх нас",
    perks: ["Морин аялал", "Түүдэг гал"],
    featured: false
  },
  {
    id: 4,
    title: "Чежү Арал - Визагүй",
    category: "nature",
    location: "Чежү, Солонгос",
    duration: "5 Өдөр",
    rating: 4.8,
    price: 2500000,
    image: "/jeju.jpg",
    ageGroup: "5+ нас",
    perks: ["Усан онгоц", "Музей"],
    featured: false
  },
  {
    id: 5,
    title: "Пүкет - Заантай аялал",
    category: "resort",
    location: "Пүкет, Тайланд",
    duration: "7 Өдөр",
    rating: 4.9,
    price: 3100000,
    image: "/phuket.jpg",
    ageGroup: "Бүх нас",
    perks: ["Заан унах", "Арал тойрох"],
    featured: true
  },
  {
    id: 6,
    title: "Сингапур - Universal Studios",
    category: "theme_park",
    location: "Сингапур",
    duration: "6 Өдөр",
    rating: 5.0,
...
const FamilyPackagesPage = () => {
  ...
  const filtered = familyTrips.filter(
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-24 pb-20 overflow-hidden relative">
      ...
      {/* Floating Icons (Playful Atmosphere) */}
      ...
      <div className="container mx-auto px-4 relative z-10 max-w-7xl">
        ...
        >
          <AnimatePresence>
            {filtered.map((trip) => (
              <FamilyCard key={trip.id} trip={trip} />
            ))}
          </AnimatePresence>
        </motion.div>
...
// 2. Family Package Card
const FamilyCard = ({ trip }: { trip: any }) => {
  return (
    <motion.div
      layout
    ...
    >
      ...
      <div className="relative h-64 overflow-hidden">
        <Link href={`/packages/family/${trip.id}`}>
