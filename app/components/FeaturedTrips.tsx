...
const tripsData = [
  {
    ...
    price: "450,000₮",
    image: "/lake.jpg", 
    tags: ["Морин аялал", "Завь"]
  },
  {
    id: 2,
    title: "Парис & Европын Тур",
    category: "Хотын Аялал",
...
const TripCard = ({ trip, index }: { trip: typeof tripsData[0], index: number }) => {
      ...
      <div className="bg-white rounded-[2.5rem] p-3 shadow-xl shadow-slate-200/50 hover:shadow-2xl hover:shadow-sky-200/40 border border-white transition-shadow duration-500 h-full flex flex-col relative z-10 overflow-hidden">
         ...
         <div className="p-5 flex flex-col flex-grow">
            ...
            <div className="flex items-center gap-4 text-slate-500 text-sm mb-6">
               ...
               <div className="flex items-center gap-1.5">
                  <FaClock className="text-sky-400" /> {trip.days}
               </div>
            </div>
