...
const Navbar: React.FC<{ dictionary: any }> = ({ dictionary }) => {
  ...
  // Reconstruct Links from Dictionary
  const currentLinks: NavLinkItem[] = [
    { id: "home", label: t.home, href: "/" },
    {
      ...
      href: "/packages",
      subMenu: [
        { id: "europe", label: t.europe, href: "/packages/europe" },
        { id: "mongolia", label: t.mongolia, href: "/packages/mongolia" },
      ],
    },
              ...
              <div className="grid grid-cols-3 gap-2 mb-8">
                {LANGUAGES.map((lang) => (
                  <button
                    ...
                    className={`flex flex-col items-center gap-1.5 py-3 rounded-2xl border transition-all ${language === lang.code
