...
const timelineEvents = [
  { year: "2015", title: "TripExplorer-ийн Эхлэл", text: "Нэгэн мөрөөдлөөс эхэлсэн бидний аялал Монголын аялал жуулчлалын салбарт шинэ өнгө төрх нэмэх зорилготойгоор байгуулагдсан." },
...
const HeroSection = () => (
  <section className="relative h-[70vh] min-h-[500px] flex items-center justify-center text-center text-white overflow-hidden">
    ...
    <div className="relative z-20 container mx-auto px-4">
      ...
      >
        Бидний Аялал, <span className="text-sky-400">Таны Адал Явдал</span>
      </motion.h1>
      <motion.p 
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        TripExplorer бол зүгээр нэг компани биш, харин адал явдалд дурлагсдын нэгдэл юм. Бидний түүхтэй танилцана уу.
      </motion.p>
    </div>
  </section>
);
   ...
   <section className="bg-white py-24">
      <div className="container mx-auto px-4 max-w-5xl">
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <ValueCard icon={FaShieldAlt} title="Аюулгүй Байдал" text="Таны аюулгүй байдлыг бид нэгдүгээрт тавьж, бүх аяллыг даатгалд хамруулдаг." />
            <ValueCard icon={FaHandshake} title="Итгэлцэл" text="Нээлттэй, ил тод байдлыг эрхэмлэж, хэрэглэгчидтэйгээ урт хугацааны харилцааг бий болгоно." />
            <ValueCard icon={FaLightbulb} title="Шинэлэг Сэтгэлгээ" text="Бид үргэлж шинийг эрэлхийлж, танд илүү сонирхолтой, өвөрмөц аяллуудыг санал болгохыг зорьдог." />
         </div>
      </div>
   </section>
);
